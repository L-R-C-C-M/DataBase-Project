<template>
  <div class="containerFlex">
    ...
    >
      <!-- 被寻人照片 -->
      <div class="PhotoOnly" @click="clickPhoto(index)">
        <el-row>
          <el-col :span="8">
            <div class="thePhoto">
              <img
          ...
          <el-col :span="16">
            <div class="informationBlock">
              <div class="line">
                ...
                <h>{{ lostInfoList[index].StayType }}</h>
              </div>
              <div class="line">
                <h class="tableTitle">姓名:</h>
                <h>{{ lostInfoList[index].StayName }}</h>
              </div>
              <div class="line">
                <h class="tableTitle">性别:</h>
                <h>{{ lostInfoList[index].StayPrice }}</h>
              </div>
              <div class="line">
...
export default {
  ...
  methods: {
    clickPhoto(index) {
      //点击跳转到寻人信息的详情页
      this.$router.push({ path: "/missingpersonInfo", query: {} });
    },
    //为了把数据传出去
    // getInfo () {
    //   return {
    //     currentData: this.lostInfoList
    //   }
    // }
  },
};
