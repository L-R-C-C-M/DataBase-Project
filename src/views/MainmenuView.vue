  ...
  >
    ...
    <el-main style="background-color:#F5F5F5">
      ...
      <div style="margin-top:1%;margin-right:1%;margin-bottom:1%;">
        <h
          style="padding-right: 85%;font-size:8px;font-weight: 600;color:#C2C2C2">
          共搜索到
          <h style="color:#2E74B6">
            {{searchNum}}条
          </h>寻人信息
        </h>
      </div>
      ...
      <div class="last-page">
        <div class="bottom-style">
          ...
          <div class="total-number">
            <div class="total-item">|已发布启事 {{padding1(itemNum,length)}}个</div>
            <div class="total-item">|共收到线索 {{padding1(clueNum,length)}}条</div>
            <div class="total-item">|累计已帮助 {{padding1(peopleNum,length)}}人</div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    leadTo () {
      this.$router.push({ path: "../views/releaseInformation", query: {} });
    },
    //分页
