...
<template>
  <div class="container">
    <div class="box">
      <div class="quit" onclick="window.open('/report','_self')">{{ icon }}<span>返回</span></div>
      <div class="title">
        公安部：全国免费采血点適5000个，寻亲人员可 就近采集
      </div>
      <div class="time">发布时间：2022-07-09</div>
      <div class="line"></div>
      ...
      <div class="text">
        ...
        力量打拐寻亲，公安部近日公布全国5000余个免费采血点信息，进一步便利广大群众及时就近采血，助力被拐家庭早日实现团
        圆。
      </div>
      <div class="text">
